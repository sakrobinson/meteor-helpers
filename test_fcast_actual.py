...
forecast_data = forecast_instance.get_weather_data(latitude, longitude, forecast_start_date, forecast_end_date)
actuals_data = history_instance.get_weather_data(latitude, longitude, actuals_start_date, actuals_end_date)
